...
//	private static Logger logger = Logger.getLogger(Trace.class);
	...
	public static boolean isEnabled() {
		return Logger.isDebugEnabled(Trace.class);
	}
...
//		if (logger.isErrorEnabled()) {
			...
			Logger.error(Trace.class,sb.toString(),e);
//		}
	}
	...
	static public void println(String msg, long time) {
		...
		if (time == 0)
			...
			result.append("|costtime=")
					...
					.append(msg);
		Logger.debug(Trace.class,result.toString());
	}

	static public void traceDetail(String msg) {
		Logger.info(Trace.class,msg);
	}
