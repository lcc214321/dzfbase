...
public class SessionRedisClient {
	...
	public void beat(final JedisPool pool) {
		log.info("HeartBeatSessionJedis  心跳检测注册");
		TimerTask task = new TimerTask() {
			@Override
			public void run() {
				log.info("HeartBeatSessionJedis  心跳检测开始");
				Jedis jedis = null;
				try{
					jedis = pool.getResource();
					log.info("HeartBeatSessionJedis  心跳检测正常");
	...
	public void initData(){
		...
		InputStream in = null;
		try {
			if (this.getClass().getResource("/jedis_session_config.properties") != null){
				in = this.getClass().getResourceAsStream("/jedis_session_config.properties");
			}else{
	...
	//
	// }
	public static SessionRedisClient getInstance() {
		if (rclient == null) {
			synchronized (SessionRedisClient.class) {
				if (rclient == null)
					rclient = new SessionRedisClient();
			}
		}
		return rclient;
	}

	public Object TransactionExec(ISessionTransactionCallback ircb) {
...
//				config.setMaxWaitMillis(100000l);
	...
	// JedisShardInfo jsi=new JedisShardInfo("172.16.2.142", 6379, "master");
	...
	// System.out.println("一次性删除key201,key202："+jedis.del(new String[]{"key201",
	// "key202"}));
	// System.out.println("一次性获取key201,key202,key203,key204各自对应的值："+
	// jedis.mget("key201","key202","key203","key204"));
	// System.out.println();
	...
	// System.out.println("原先key301不存在时，新增key301："+shardedJedis.setnx("key301",
	// "value301"));
	// System.out.println("原先key302不存在时，新增key302："+shardedJedis.setnx("key302",
	// "value302"));
	// System.out.println("当key302存在时，尝试新增key302："+shardedJedis.setnx("key302",
	// "value302_new"));
	...
	// // 设置key的有效期，并存储数据
	// System.out.println("新增key303，并指定过期时间为2秒"+shardedJedis.setex("key303", 2,
	// "key303-2second"));
	...
	// System.out.println("key302原值："+shardedJedis.getSet("key302",
	// "value302-after-getset"));
	// System.out.println("key302新值："+shardedJedis.get("key302"));
	//
	// System.out.println("=============获取子串=============");
	// System.out.println("获取key302对应值中的子串："+shardedJedis.getrange("key302", 5,
	// 7));
	// }
	//
	...
	// 0, -1));
	// // 删除区间以外的数据
	// System.out.println("删除下标0-3区间之外的元素："+shardedJedis.ltrim("stringlists", 0,
	// 3));
	...
	// System.out.println("子串-第二个开始到结束："+shardedJedis.lrange("stringlists", 1,
	// -1));
	// // 获取列表指定下标的值
	...
	//
	// System.out.println("=============增=============");
	// System.out.println("向sets集合中加入元素element001："+jedis.sadd("sets",
	// "element001"));
	// System.out.println("向sets集合中加入元素element002："+jedis.sadd("sets",
	// "element002"));
	// System.out.println("向sets集合中加入元素element003："+jedis.sadd("sets",
	// "element003"));
	// System.out.println("向sets集合中加入元素element004："+jedis.sadd("sets",
	// "element004"));
	...
	//
	// System.out.println("=============查=============");
	// System.out.println("判断element001是否在集合sets中："+jedis.sismember("sets",
	// "element001"));
	...
	// System.out.println("sets1中添加元素element001："+jedis.sadd("sets1",
	// "element001"));
	// System.out.println("sets1中添加元素element002："+jedis.sadd("sets1",
	// "element002"));
	// System.out.println("sets1中添加元素element003："+jedis.sadd("sets1",
	// "element003"));
	// System.out.println("sets1中添加元素element002："+jedis.sadd("sets2",
	// "element002"));
	// System.out.println("sets1中添加元素element003："+jedis.sadd("sets2",
	// "element003"));
	// System.out.println("sets1中添加元素element004："+jedis.sadd("sets2",
	// "element004"));
	// System.out.println("查看sets1集合中的所有元素:"+jedis.smembers("sets1"));
	// System.out.println("查看sets2集合中的所有元素:"+jedis.smembers("sets2"));
	// System.out.println("sets1和sets2交集："+jedis.sinter("sets1", "sets2"));
	// System.out.println("sets1和sets2并集："+jedis.sunion("sets1", "sets2"));
	// System.out.println("sets1和sets2差集："+jedis.sdiff("sets1",
	// "sets2"));//差集：set1中有，set2中没有的元素
	//
	// }
	...
	//
	// System.out.println("=============增=============");
	// System.out.println("zset中添加元素element001："+shardedJedis.zadd("zset", 7.0,
	// "element001"));
	// System.out.println("zset中添加元素element002："+shardedJedis.zadd("zset", 8.0,
	// "element002"));
	// System.out.println("zset中添加元素element003："+shardedJedis.zadd("zset", 2.0,
	// "element003"));
	// System.out.println("zset中添加元素element004："+shardedJedis.zadd("zset", 3.0,
	// "element004"));
	// System.out.println("zset集合中的所有元素："+shardedJedis.zrange("zset", 0,
	// -1));//按照权重值排序
	// System.out.println();
	//
	// System.out.println("=============删=============");
	// System.out.println("zset中删除元素element002："+shardedJedis.zrem("zset",
	// "element002"));
	...
	// 1.0, 5.0));
	// System.out.println("查看zset集合中element004的权重："+shardedJedis.zscore("zset",
	// "element004"));
	...
	//
	// System.out.println("=============增=============");
	// System.out.println("hashs中添加key001和value001键值对："+shardedJedis.hset("hashs",
	// "key001", "value001"));
	// System.out.println("hashs中添加key002和value002键值对："+shardedJedis.hset("hashs",
	// "key002", "value002"));
	// System.out.println("hashs中添加key003和value003键值对："+shardedJedis.hset("hashs",
	// "key003", "value003"));
	// System.out.println("新增key004和4的整型键值对："+shardedJedis.hincrBy("hashs",
	// "key004", 4l));
	// System.out.println("hashs中的所有值："+shardedJedis.hvals("hashs"));
	// System.out.println();
	//
	// System.out.println("=============删=============");
	// System.out.println("hashs中删除key002键值对："+shardedJedis.hdel("hashs",
	// "key002"));
	// System.out.println("hashs中的所有值："+shardedJedis.hvals("hashs"));
	// System.out.println();
	//
	// System.out.println("=============改=============");
	// System.out.println("key004整型键值的值增加100："+shardedJedis.hincrBy("hashs",
	// "key004", 100l));
	// System.out.println("hashs中的所有值："+shardedJedis.hvals("hashs"));
	// System.out.println();
	//
	// System.out.println("=============查=============");
	// System.out.println("判断key003是否存在："+shardedJedis.hexists("hashs",
	// "key003"));
	// System.out.println("获取key004对应的值："+shardedJedis.hget("hashs", "key004"));
	// System.out.println("批量获取key001和key003对应的值："+shardedJedis.hmget("hashs",
	// "key001", "key003"));
	...
	public static void main(String[] args) {
		...
		SessionRedisClient.getInstance().clear();
	}
}