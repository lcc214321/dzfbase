...
public class JSONSerializer {
    ...
    public final void write(final Object object) {
       ...
       final ObjectSerializer writer = getObjectWriter(clazz);

       
        	setObject(object,new Callback(){

				@Override
				public void run() {
					 try {
					writer.write(JSONSerializer.this, object, null, null, 0);
					   } catch (IOException e) {
    ...
    protected void setObject(Object object,Callback cb){
    ...
    public final void writeWithFieldName(final Object object, final Object fieldName,final Type fieldType, final int fieldFeatures) {
       // try {
            ...
            setObject(object,new Callback(){
				...
				public void run() {
					 try {
						  writer.write(JSONSerializer.this, object, fieldName, fieldType, fieldFeatures);
					   } catch (IOException e) {
				            throw new JSONException(e.getMessage(), e);
				        }
				}
